...
@section('content_header')
    <h1 class="m-0 text-dark">Actualizar distribución</h1>
@stop
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                {!! Form::model($coursemanagment, ['route' => ['admin.coursemanagments.update', $coursemanagment], 'method' => 'put']) !!}
                ...
                @enderror
                    ...
                    {!! Form::submit('Actualizar distribución', ['class' =>'btn btn-primary btn-lg']) !!}
